...
import { cos, sin } from "../util/math.util.js";
import KeyLabelComponent from "./key-label.component.js";
...
const SwitchSectorComponent: React.FC<SwitchSectorComponentProps> = ({
  ...
  return (
    <g>
      <path
        className="fill-(--cc-key-color) stroke-(--cc-symbol-color)"
        d={sectorPath}
        strokeWidth={strokeWidth}
      ></path>
      <path
        className="fill-(--cc-pointer-color)"
        d={sectorPath + " Z"}
        opacity={
