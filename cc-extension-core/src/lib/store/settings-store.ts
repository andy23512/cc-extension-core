...
/**
 * Reads a setting that has a separate value per layout type, picking the
 * `lite*` variant while the Lite layout is selected. Exported for testing.
 */
export const selectLayoutDependentSetting =
